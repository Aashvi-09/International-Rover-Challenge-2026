...
2. Drive System (6-Wheel Configuration):
   ...
   Powered via dedicated PCB-based power distribution and
...
3. Robotic Arm (6 DOF):
   ...
   Independent PCB for arm power management and
...
4. Sensing & Navigation:
   ...
   MQ135 gas sensor and
   BME280 environmental sensor
5. Vision System:
   Top-mounted camera for wide-angle monitoring,
   Front camera integrated with LiDAR for navigation and
   Arm-mounted camera for precision manipulation tasks
6. Communication System:
   Antenna-based long-range communication,
   Signal conversion interface connected to Intel NUC and
   Real-time telemetry exchange between rover and base station

Competition Missions:
1. ABEX Mission:
   Soil excavation using auger mechanism and Labart sensor integrated for in-soil environmental measurement and chemical parameter analysis.
2. RADO Mission:
...
Technical Challenges:
  ...
  Mechanical stability of arm during dynamic movement and
